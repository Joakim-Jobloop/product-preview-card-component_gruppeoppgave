  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center w-full h-screen px-4 py-12 bg-design-cream">
        <div className="grid sm:grid-cols-2 items-center justify-center sm:max-h-[608px] h-max max-w-[700px] w-[100%] grid-rows-[3fr_4fr] sm:grid-rows-none rounded-xl bg-white">
          <PerfumeImage />
